...
# # Function to get the first element of a list or return a default value
# def get_first_element(lst, default='N/A'):
...
# # Iterate through records and print every field
# for record in data:
...
#     created_time_ist=convert_utc_to_est(record.get('created', 'N/A'))

#     print("Record ID:", record.get('id', 'N/A'))
#     print("Date:", created_time_ist)
#     print("Waitlist Time:", waitlist_time_ist)
#     print("serve Time:",serve_time_ist)
#     print("updated:",updated_ist)
#     print("First Name:", record.get('firstName', 'N/A'))
#     print("Last Name:", record.get('lastName', 'N/A'))
#     print("Phone:", record.get('phone', 'N/A'))
#     print("Country:", record.get('country', 'N/A'))
#     print("City:", record.get('city', 'N/A'))
    
#     fields = record.get('fields', {})
#     print("Carrier:", get_first_element(fields.get('tcY1X5Kb7h2uIWK53Lyg', [])))
#     print("Vehicle Type:", get_first_element(fields.get('i1I6xyqqxa6oTlE3DkYM', [])))
#     print("Trailer/Container Number:", get_first_element(fields.get('uMvYMV9AWZ1OGIbA1JKn', [])))
#     print("Destination:", get_first_element(fields.get('fikIvjiydrX5ofr6RvNi', [])))
#     print("Broker:", get_first_element(fields.get('NIzqc21iVthkg02MTLGG', [])))
#     print("Scheduled Appointment Time:", get_first_element(fields.get('7vccTLW6wx0uJTI8pTGV', [])))
#     print("Customer Name:", get_first_element(fields.get('60kWvZTF6SNkCEECXi66', [])))
#     print("Scanner:", get_first_element(fields.get('vGcgWk6xCnY3CjQuEgxa', [])))
#     print("Customer PO #:", get_first_element(fields.get('L325nfBjUROuGPa3qUJu', [])))
#     print("Dispatcher Name:", get_first_element(fields.get('w22E7B7dLi4SYeXxgzLG', [])))
#     print("Dispatcher Phone:", get_first_element(fields.get('ot2ggPrasvp776PDLArX', [])))
#     print("Dock In Time:", get_first_element(fields.get('8WHDY3nMaW2GlARauOn5', [''])))
#     print("Dock Out Time:", get_first_element(fields.get('BkDnZV8ZKyp8CH0oBacG', [])))
#     print("Poles Used:", get_first_element(fields.get('DAFP7BsGgqUest0w98tL', [])))
#     print("Timbers Used:", get_first_element(fields.get('RX6CchYy0g2NCGDu8wqx', [])))
...
# url = "https://api.waitwhile.com/v2/visits/export?format=JSON&fromTime=2023-09-27T09%3A44%3A00Z&toTime=2023-09-28T09%3A44%3A00Z&dateRangeField=updated"
...
#     # Create PDF files for each record
#     for record in data:
#         waitlist_time_ist = convert_utc_to_est(record.get('waitlistTime', 'N/A'))
#         serve_time_ist = convert_utc_to_est(record.get('serveTime', 'N/A'))

#         # Check if WAITLIST_TIME exists but SERVE_TIME does not
#         if waitlist_time_ist != 'N/A' and serve_time_ist == 'N/A':
#             # Create a PDF file with a name based on the record's ID
#             pdf_file = f"record_{record.get('id', 'N/A')}.pdf"

#             # Create a PDF report with A4 page size for this record
#             c = canvas.Canvas(pdf_file, pagesize=A4)
#             c.setFont("Helvetica", 12)

#             c.drawString(100, A4[1] - 100, f"Record ID: {record.get('id', 'N/A')}")
#             c.drawString(100, A4[1] - 120, f"Date: {record.get('created', 'N/A')}")
#             c.drawString(100, A4[1] - 140, f"Waitlist Time: {waitlist_time_ist}")
#             c.drawString(100, A4[1] - 160, f"Serve Time: {serve_time_ist}")
#             # Add other fields as needed

#             # Save the PDF file for this record
#             c.save()

#     print("PDF files generated for each record.")
# else:
...
#             if waitlist_time_ist != 'N/A' and serve_time_ist == 'N/A':
#                 pdf_file = os.path.join(day_folder_path, f"record_{fetched_data.get('Id', 'N/A')}.pdf")
...
#         [Paragraph(f"Date: <b>{data.get('Date', 'N/A')}</b>", style_normal), ''],
...
#         [Paragraph(f"Phone: <b>{data.get('Phone', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Country: <b>{data.get('Country', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"City: <b>{data.get('City', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Carrier: <b>{data.get('Carrier', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Destination: <b>{data.get('Destination', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Trailer/Container Number: <b>{data.get('Trailer/Container Number', 'N/A')}</b>",
#                    style_normal), ''],
#         [Paragraph(f"Vehicle Type: <b>{data.get('Vehicle Type', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Scheduled Appointment Time: <b> {data.get('Scheduled Appointment Time', 'N/A')}</b>",
#                    style_normal), ''],
#         [Paragraph(f"Dispatcher Name: <b>{data.get('Dispatcher Name', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Dispatcher Phone: <b>{data.get('Dispatcher Phone', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Customer Name: <b>{data.get('Customer Name', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Scanner: <b>{data.get('Scanner', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Loader:_______________________", style_normal), ''],
#         [Paragraph(f"Dock In Time: <b>{data.get('Dock In Time', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Dock Out Time: <b>{data.get('Dock Out Time', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Timbers Used: <b>{data.get('Timbers Used', 'N/A')}</b>", style_normal), ''],
#         [Paragraph(f"Poles Used: <b>{data.get('Poles Used', 'N/A')}</b>", style_normal), ''],
...
#     data_list = fetch_data_from_api(url, headers)
...
#     current_time = datetime.now()  # Use dt instead of datetime
    
#     # Calculate the starting time (morning of the previous day at 4 AM)
#     start_time = current_time - timedelta(days=1)
#     start_time = start_time.replace(hour=4, minute=0, second=0, microsecond=0)
    
#     # Calculate the ending time (morning of the current day at 4 AM)
...
#             if waitlist_time_ist != 'N/A' and serve_time_ist == 'N/A':
#                 # pdf_file = os.path.join(day_folder_path, f"record_{fetched_data.get('Id', 'N/A')}.pdf")
#                 pdf_file = os.path.join(day_folder_path, f"record_{fetched_data.get('Id', 'N/A')}_{fetched_data.get('First Name', 'N/A')}_{fetched_data.get('Last Name', 'N/A')}.pdf")
...
#     # Calculate the starting time (tomorrow morning at 6 AM)
#     start_time = current_time + timedelta(days=1)
#     start_time = start_time.replace(hour=6, minute=0, second=0, microsecond=0)

#     # Calculate the ending time (day after tomorrow morning at 6 AM)
...
#             updated_value = record.get('updated', 'N/A')
...
#                 if generated_data[record_id] == updated_value:
...
#                 doc.build(content_list)
#                 print(f'PDF saved at {pdf_file}')
#                 generated_data[record_id] = updated_value
...
#         url=generate_dynamic_url()
#         #url = "https://api.waitwhile.com/v2/visits/export?format=JSON&fromTime=2023-09-29T06%3A00%3A00%2B0000&toTime=2023-09-30T06%3A00%3A00%2B0000&dateRangeField=updated"
#         headers = {"apikey": "jYHW6jItb9fQxUD57YHSIn7b"}
...
#---------------------------------API key fetching with text file---------------------------------------------------------
