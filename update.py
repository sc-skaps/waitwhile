...
#     if utc_time_string is None or utc_time_string == 'N/A':
#         return 'N/A'
...
#         return "N/A"
#     except Exception as e:
#         print(f"Error converting UTC to EST: {e}")
#         return "N/A"
...
#             finished_time_ist=convert_utc_to_est(record.get('completedTime', 'N/A'))
...
#         # Create a directory to store PDF files
#         exported_path='C:/Users/shashwat/Desktop/Simple'
#         base_directory=exported_path
#         current_date = datetime.now()
#         year_folder_name = f"Shipping {current_date.year}"
#         waitwhile_folder_name = "Waitwhile"
...
#         # Initialize a counter for handling duplicate PDFs
#         counter = 1
...
#                     # If a PermissionError occurs, increment the counter and create a new PDF with a different name
#                     pdf_file = os.path.join(day_folder_path, f"{fetched_data.get('First Name', 'N/A')}_{fetched_data.get('Last Name', 'N/A')}_{fetched_data.get('Phone', 'N/A')}_{counter}.pdf")
#                     counter += 1
#                     continue
            ...
            if (waitlist_time_ist != 'N/A' and serve_time_ist == 'N/A') or serve_time_ist != 'N/A':
                try:
                    ...
                    while os.path.exists(pdf_file):
                        # If a file with the same name already exists, add "_1", "_2", etc. to the file name
                    ...
                    # If a PermissionError occurs again, increment the counter suffix and create a new PDF with an incremented name
                    counter_suffix += 1
                    continue
